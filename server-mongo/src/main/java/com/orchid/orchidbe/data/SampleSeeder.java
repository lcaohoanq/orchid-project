    ...
    public void run(String... args) throws Exception {
        ...
        if (accountRepository.findAll().isEmpty()) {
            var acc1 = Account.builder()
                ...
                .role(roles.isEmpty() ? null : roles.get(0).getName())
                .build();
            ...
            var acc2 = Account.builder()
                ...
                .password(hashedPassword)
                .role(roles.size() > 1 ? roles.get(1).getName() : null)
                .build();
            ...
            var acc3 = Account.builder()
                ...
                .password(hashedPassword)
                .role(roles.size() > 2 ? roles.get(2).getName() : null)
                .build();
            ...
            var acc4 = Account.builder()
                ...
                .password(hashedPassword)
                .role(roles.size() > 2 ? roles.get(3).getName() : null)
                .build();
        ...
        if (orderRepository.findAll().isEmpty()) {
            Order ord1 = Order.builder()
                ...
                .accountId(accounts.isEmpty() ? null : accounts.get(2).getName())
                .build();
            ...
            Order ord2 = Order.builder()
                ...
                .accountId(accounts.size() > 1 ? accounts.get(2).getName() : null)
                .build();
            ...
            Order ord3 = Order.builder()
                ...
                .accountId(accounts.size() > 2 ? accounts.get(2).getName() : null)
                .build();
            ...
            OrderDetail d1 = OrderDetail.builder()
                .price(10.0)
                .quantity(2)
                .orchidId(orchids.isEmpty() ? null : orchids.get(0).getName())
            ...
            OrderDetail d2 = OrderDetail.builder()
                .price(15.0)
                .quantity(1)
                .orchidId(orchids.size() > 1 ? orchids.get(1).getName() : null)
            ...
            OrderDetail d3 = OrderDetail.builder()
                .price(20.0)
                .quantity(3)
                .orchidId(orchids.size() > 2 ? orchids.get(2).getName(): null)
