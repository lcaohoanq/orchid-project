...
public class AccountServiceImpl implements AccountService {
    ...
    public void add(AccountDTO.CreateAccountReq account) {
        ...
        newAccount.setRole(defaultRole.getName());
    ...
    public void addEmployee(AccountDTO.CreateStaffReq account) {
        ...
        newAccount.setRole(roleService.getByName(RoleName.STAFF).getName());
    ...
    @Override
    @Transactional
    public void update(String id, UpdateAccountReq account) {
        ...
        if (account.roleName() != null) {
            ...
            existingAccount.setRole(role.getName());
        }
